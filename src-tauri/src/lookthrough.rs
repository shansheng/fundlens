...
pub fn sector_l1_of(industry_em: &str) -> &'static str {
    ...
    // v2.4.1 补充映射：东财新版「Ⅱ」后缀板块与新增细分名（与下方 EXACT 同语义，独立维护防大表移位）。
    // 归类依据：Ⅱ 后缀=既有板块细分子类（调味发酵品Ⅱ≈调味发酵品 等）；其余按行业常识归入 9 大类。
    const EXACT2: &[(&str, &str)] = &[
        // 科技TMT
        ("元件", "科技TMT"), ("资讯科技器材", "科技TMT"), ("IT服务Ⅱ", "科技TMT"),
        ("媒体及娱乐", "科技TMT"), ("广告营销", "科技TMT"), ("电讯", "科技TMT"),
        // 国防军工
        ("航空装备Ⅱ", "国防军工"), ("航海装备Ⅱ", "国防军工"), ("地面兵装Ⅱ", "国防军工"),
        // 周期资源
        ("炼化及贸易", "周期资源"), ("农化制品", "周期资源"), ("一般金属及矿石", "周期资源"),
        ("普钢", "周期资源"), ("特钢Ⅱ", "周期资源"), ("冶钢原料", "周期资源"),
        ("非金属材料Ⅱ", "周期资源"), ("装修建材", "周期资源"), ("造纸", "周期资源"),
        ("原材料", "周期资源"), ("塑料", "周期资源"), ("油气开采Ⅱ", "周期资源"), ("油服工程", "周期资源"),
        // 基建公用·交运
        ("基础建设", "基建公用·交运"), ("建筑", "基建公用·交运"), ("专业工程", "基建公用·交运"),
        ("房屋建设Ⅱ", "基建公用·交运"), ("工程咨询服务Ⅱ", "基建公用·交运"), ("工用运输", "基建公用·交运"),
        // 高端制造
        ("金属新材料", "高端制造"), ("其他电源设备Ⅱ", "高端制造"), ("工业工程", "高端制造"),
        // 可选消费
        ("乘用车", "可选消费"), ("商用车", "可选消费"), ("摩托车及其他", "可选消费"),
        ("家居用品", "可选消费"), ("家庭电器及用品", "可选消费"), ("饰品", "可选消费"),
        ("文娱用品", "可选消费"), ("个护用品", "可选消费"), ("专业服务", "可选消费"), ("专业连锁Ⅱ", "可选消费"),
        // 主要消费
        ("饮料乳品", "主要消费"), ("调味发酵品Ⅱ", "主要消费"), ("种植业", "主要消费"),
        ("饲料", "主要消费"), ("食物饮品", "主要消费"), ("农产品加工", "主要消费"),
        // 金融地产
        ("其他金融", "金融地产"),
    ];
    if let Some(&(_, l1)) = EXACT2.iter().find(|(k, _)| *k == name) {
        return l1;
    }
